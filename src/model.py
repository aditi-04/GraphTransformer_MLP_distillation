...
class TransformerModel(nn.Module):
    ...
    def forward(self, batched_data):
        ...
        for enc_layer in self.layers:
            tensor, attention_matrix = enc_layer(tensor)
        ...
        return torch.log_softmax(output, dim=1) , gnn_feats, all_attentions
...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, attn_bias=None):
        ...
        _, attention_matrix = self.self_attention(y, y, y, attn_bias)
        y, _ = self.self_attention(y, y, y, attn_bias)
